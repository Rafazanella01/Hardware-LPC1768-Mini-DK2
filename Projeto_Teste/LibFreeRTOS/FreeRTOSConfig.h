...
#define configTOTAL_HEAP_SIZE			( 28000 )//buffers da stack TCP/IP tb sao alocados do heap
#define configMAX_TASK_NAME_LEN			( 12 )
#define configUSE_TRACE_FACILITY		0 /* This is set to one so each task is given a unique number, which is then used to generate the logic analyzer output. */
...
//#define configEXPECTED_NO_RUNNING_TASKS		( 10 )
/*
