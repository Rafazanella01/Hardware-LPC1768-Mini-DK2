...
#define ipconfigIP_TASK_STACK_SIZE_WORDS	150//era 150
...
//configuracoes p/ reduzir RAM
#define ipconfigNETWORK_MTU   644//no minimo 586 p/ DHCP
#define ipconfigTCP_MSS       460
#define ipconfigTCP_RX_BUF_LENGTH   ( 2 * ipconfigTCP_MSS )
#define ipconfigTCP_TX_BUF_LENGTH	( 2 * ipconfigTCP_MSS )
...
//#define ipconfigPACKET_FILLER_SIZE		2//funcionamento incorreto
#define ipconfigPACKET_FILLER_SIZE		8//funcionamento OK

#define ipconfigTCP_HANG_PROTECTION 1
#define ipconfigTCP_HANG_PROTECTION_TIME    5
...
/* If ipconfigCAN_FRAGMENT_OUTGOING_PACKETS is set to 1 then UDP packets that585-28
